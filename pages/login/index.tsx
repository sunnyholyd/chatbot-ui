...
export default function Login() {
  ...
  return (
    <>
      <div className={`flex flex-col items-center justify-center h-screen w-screen text-sm text-white dark:text-white`}>
        <form className={`w-full max-w-xs bg-black p-8 rounded-lg shadow-md`} onSubmit={handleLogin}>

          <h2 className={`text-center text-2xl m-5`}>Login</h2>
          ...
          <button
            className={`w-full px-4 py-2 mt-6 border`}
            type="submit"
            disabled={submitting}
          >
            Login
